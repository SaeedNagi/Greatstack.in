    ...
    <div className="title">
     ...
     <div className='contact'>
            <div className="colloum">
                ...
                <div className='list'>
                    <li>
                        <img src='./contact.png' alt=''></img>  Contact@GreatStack.dev
                        </li>
                        </div>              
                <div className='list'>
                    <li>
                        <img src='./phone.png' alt=''></img>  +1 123-456-7890
                        </li>
                        </div>    
                <div className='list'>
                    <li>
                        <img src='./location.png' alt=''></img>  77 Massachusetts Ave, Cambridge<br />
        ...
        <div className="feet">
             ...
             <ul>
            <li><a href="https://www.youtube.com/@GreatStackDev/videos">Terms of Services</a></li> 
            <li><a href="https://www.youtube.com/@GreatStackDev/videos">Privacy Policy</a></li>
             </ul>
        </div>
    </>
  )
